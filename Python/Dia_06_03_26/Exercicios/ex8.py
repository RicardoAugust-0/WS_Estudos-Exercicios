# Escreva um programa para calcular o preço a pagar pelo fornecimento de energia elétrica. Será necessária a quantidade de kWh consumido e o tipo de instalação: R para residências, I para industrias e C para comércios. Calcule o preço a pagar de acordo com a tabela a seguir
